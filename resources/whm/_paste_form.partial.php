 ...
 * disclosure. Renders nothing on its own; expects $h(), $tokensVm,
 * and (optionally) $serverIp to be in scope from the parent
 * index.live.php.
 *
...
?>
<ol class="step-list">
  <li>In the Cloudflare tab that opened, optionally lock the token to this server's IP under <strong>Client IP Address Filtering</strong><?= ($serverIp ?? '') !== '' ? ' (' . $h($serverIp) . ')' : '' ?>.</li>
  <li>Scroll to <strong>Create Token</strong> and click it. The permissions are pre-filled.</li>
